...
import KidsHairCut1 from '../Assets/Images/Kidshaircut1.png';
import KidsHairCut2 from '../Assets/Images/Kidshaircut2.png';
...
export default function App() {
    ...
    const Srt = [
        {
            title: 'Kid Hair Cut-Boys ',
            rating: 4.73, price: `129`, time: '25 min', image: KidsHairCut1,
            d1: `Boys Age btw 3-12 years of age`,

        },
        {
            title: `Kid's Hair Cut-Girls`,
            rating: 4.66, price: `139`, time: '30 min', image: KidsHairCut2,
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <GrayHeader title="Kid's Haircut" />
            <View style={styles.kidsCntnr}>
                <Text style={styles.KidsText}>Parental Supervision Advised</Text>
            </View>
