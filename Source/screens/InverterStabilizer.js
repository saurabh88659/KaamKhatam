...
// const InverterStabilizer = ({props}) => {
...
// export default InverterStabilizer;
...
const InverterStabilizer = props => {
  ...
  // console.log('hlo343333333333333333ooooooo================', services);

  useEffect(() => {
    console.log('hellllll3333333333333');
    axios
      .get(
