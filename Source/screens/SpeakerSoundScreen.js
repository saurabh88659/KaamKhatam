  ...
  const Srt = [
    {
      ...
      price: `149`,
      image: nosound,
      d1: 'Average charges (upto 48 inches) Rs (500-2000)',
    },
    {
    ...
    },
    {
      ...
      time: '70 min',
      image: sound3,
      d1: 'crackling and vibrating sound',
      d2: 'Average charges (upto 48 inches) Rs (500-3500)',
    },
  ];
  return (
    <View style={styles.container}>
      ...
      />
      <GrayHeader title="Speaker/Sound " />
