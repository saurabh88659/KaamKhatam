...
import sbtvinstall from '../Assets/Images/sbtvinstall.png';
...
export default function UninstallationScreen() {
  ...
  const Srt = [
    {
      title: 'Uninstallation upto 48 inches',
      rating: 4.8,
      price: `159`,
      time: '70 min',
      image: sbtvinstall,
    ...
    {
      title: 'Uninstallation upto 98 inches',
      rating: 4.8,
      price: `278 `,
      time: '70 min',
