...
import DeluxeManicure from '../Assets/Images/Deluxe.png';
import PolishHands from '../Assets/Images/polishHands.png';
...
export default function Manicure({props, route}) {
  const preData = route?.params;
  const Srt = [
    {
      title: 'Cut,File and Polish-Hands',
      rating: 4.7,
      price: `149 `,
      time: '20 min',
      image: PolishHands,
    ...
    {
      title: `Delux Manicure`,
      rating: 4.7,
      price: `350`,
      time: '35 min',
      image: DeluxeManicure,
      d1: '4 Step manicure-Cleaning scrub, massage & mask',
    },
    {
      title: `Delux Manicure`,
      rating: 4.7,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.greyHeader}>
        <Text style={{fontWeight: 'bold', fontSize: hp('5%')}}>Manicure</Text>
      </View>
