...
import HeadMassage1 from '../Assets/Images/Headmassage1.png';
import NeckMassage from '../Assets/Images/Neckmassage.png';
...
export default function App() {
    ...
    const Srt = [
        {
            title: 'Head Massage ',
            rating: 4.71, price: `99`, time: '10 min', image: HeadMassage1,
            d1: `Quick relaxation,Hair Growth `,

        },
        {
            title: `Neck and Shoulder Massage`,
            rating: 4.6, price: `149`, time: '20 min', image: NeckMassage,
            d1: `Relax from Pain and Quick Relaxation`
        },
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <GrayHeader title='Massage Therapy ' />
