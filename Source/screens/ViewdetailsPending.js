...
const ViewdetailsPending = props => {
      ...
      <ScrollView>
        ...
        <View
          ...
          <Text
            ...
            If you cancel your order within 4 days, then refund {'\n'} would be
            provided. Otherwise, there would be no refund.
          </Text>
        </View>
        <View
          style={{
          ...
          <TouchableOpacity
            onPress={() => {
              setIndex(1);
              props.navigation.navigate('CancelBooking');
            }}
            style={{
...
export default ViewdetailsPending;
