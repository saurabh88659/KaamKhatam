  ...
  const Srt = [
    {
      ...
      time: '90 min',
      image: Cupping,
      d1: `Medium Pressure Massage Using smooth and heated stones`,
      d2: `The Heated stones and aromatic calls relaxes. `,
      d3: `30 minutes of relaxing oil massage followed by 60 minutes of massage with hot stones.`,
    },
  ];
  return (
    <View style={styles.container}>
      <Header
        ...
        title="Salon for Men"
      />
      <GrayHeader title="Hot Stone Therapy " />
