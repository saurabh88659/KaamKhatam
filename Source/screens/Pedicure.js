...
import PolishFeet from '../Assets/Images/Polishfeet.png';
...
export default function Pedicure({props}) {
  const Srt = [
    {
      title: 'Cut,File and Polish-Feets',
      rating: 4.8,
      price: `149 `,
      time: '20 min',
      image: PolishFeet,
    },
    {
      ...
      d1: '4 Step Pedicure-Cleaning scrub, massage & mask',
    },
  ];
  return (
    <View style={styles.container}>
      ...
      <View style={styles.greyHeader}>
        <Text style={{fontWeight: 'bold', fontSize: hp('5%')}}>Pedicure</Text>
      </View>
