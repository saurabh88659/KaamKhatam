...
import HaircolorMen1 from '../Assets/Images/Haircolormen1.png';
import HaircolorMen2 from '../Assets/Images/Haircolormen2.png';
...
export default function App() {
    ...
    const Srt = [
        {
            ...
            rating: 4.7, price: `189`, time: '30 min', image: HaircolorMen1,
            d1: `Product by us `,
            d2: `Product to be used`,
            d3: `Garnier Black, Brown color, Mocha`
        },
        {
            title: `Hair Color(Application)`,
            rating: 4.76, price: `150`, time: '30 min', image: HaircolorMen2,
            d1: `Color Provided by customer`
        },
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <GrayHeader title='Hair Color' />
            <GreenHeader title='Smooth and even hair color appplication' />
