...
import stonetherapyman from '../Assets/Images/stonetherapyman.png';
...
export default function HotStonesTherapyMan({props}) {
  const Srt = [
    {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <GrayHeader title="Hot Stones Therapy" />
