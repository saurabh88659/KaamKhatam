...
import DiamondGlow from '../Assets/Images/Diamondglow.png';
...
export default function Cleanup({props, route}) {
  const preData = route?.params;

  const Srt = [
    {
      title: 'Papaya Nourishing Cleanup ',
      rating: 4.6,
      price: `349 `,
      time: '45 min',
      image: PapayaNourishing,
      d1: 'Cleaning Scrubbing of face gently.',
      d2: '10 min Massage,hydration boosting mask to give glowing look ',
    },
    {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.greenHeader}>
        <Text
          ...
          Sanitized tools,single-use products & Sachets
        </Text>
      </View>
