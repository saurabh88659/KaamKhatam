...
export default function Installation() {
  const Srt = [
    ...
    },
    {
      ...
      time: '90 min',
      image: SplitFaceAc,
      d1: `Outer frame & power outlet should  available`,
      d2: `Woodwork including any cutting or fitting are not part of the service`,
    },
  ];
  return (
    <View style={styles.container}>
      <Header
        ...
        title="Salon for Men"
      />
      <GrayHeader title="Installation & Uninstallation " />
